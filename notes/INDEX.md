...
| --- | --- | --- | --- |
| [Contains Duplicate](problems/contains-duplicate.md) | Easy | NeetCode 150, NeetCode 250 | Needs details |
| [Minimum Time to Make Rope Colorful](problems/minimum-time-to-make-rope-colorful.md) | Medium | General Practice | Complete |
